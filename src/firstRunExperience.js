...
export const FIRST_RUN_STORAGE_KEY = 'r1:first-run-mission:v1';
/** Per-session dismissal. Written by every close path; scoped to sessionStorage. */
export const FIRST_RUN_SESSION_KEY = 'r1:first-run-mission-session:v1';
 ...
 * Layer enablement IS durable in this app (`r1:layer-state:v2`, written by
 ...
 *   NOT TOUCHED           detection allocation (`r1:detection-allocation:v1`),
