...
// plane being tracked. Claiming the 'r1-trail:' id namespace makes
...
registerPickOwner('trails', (pickedId) => String(pickedId).startsWith('r1-trail:'));
