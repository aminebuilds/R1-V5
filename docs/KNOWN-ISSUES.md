...
Workaround:
- In browser console:
  - `localStorage.removeItem('r1.v6.panelPos.cctv-panel');`
  - `localStorage.removeItem('r1.v6.panelCollapsed.cctv-panel');`
  - `location.reload();`

Related keys (current versions):
- Panel positions: `r1.v7.panelPos.<panel-id>` (re-versioned 2026-06-10)
- Panel collapsed state: `r1.v6.panelCollapsed.<panel-id>`
- CCTV calibration: `r1.cctv.calibration.v2`
