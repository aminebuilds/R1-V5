...
async function main() {
  ...
  try {
    ...
    await page.waitForFunction(() => window.__r1?.styleManager, { timeout: 90_000 });
    ...
    for (const pose of POSES) {
      ...
      const observed = await page.evaluate((wantedIds) => {
        ...
        const diagnostics = window.__r1.styleManager.getDetectionDiagnostics();
        return {
          plated: [...byId.values()],
