...
await page.waitForFunction(() => window.__r1?.dataManager && window.__r1?.viewer, { timeout: 150000 });
await sleep(2000);
...
await page.evaluate(async () => { await window.__r1.dataManager.toggle('flights'); });
