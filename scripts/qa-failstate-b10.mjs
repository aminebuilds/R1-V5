...
async function main() {
  ...
  try {
    ...
    const detect = await page.evaluate(async () => {
      ...
      const detState = r1.styleManager.getDetectionState?.() || null;
